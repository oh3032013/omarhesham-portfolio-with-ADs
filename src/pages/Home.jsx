    ...
    <div style={{ position: 'relative', minHeight: '100vh' }}>
      ...
      {activeVideoId && (
        <div style={{ position: 'fixed', inset: '0', zIndex: '100', background: 'rgba(0,0,0,0.92)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 'clamp(8px, 3vw, 16px)', backdropFilter: 'blur(4px)' }}>
          ...
          <div className="animate-scale-in" style={{ position: 'relative', width: '100%', maxWidth: '850px', aspectRatio: '16/9', borderRadius: 'clamp(8px, 2vw, 16px)', overflow: 'hidden', border: '2px solid var(--color-accent)', boxShadow: '0 0 40px rgba(0,240,255,0.3)' }}>
            <iframe 
